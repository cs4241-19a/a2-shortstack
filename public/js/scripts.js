...
$(document).ready(function () {
  $("#next").on('click', function() {
    ...
    $(".boardsection[data-board]:first-child").css({animation: "next 1s"});
    $(".boardsection[data-board]:nth-child(2)").css({animation: "next 1s"});
    $(".boardsection[data-board]:nth-child(3)").css({animation: "next 1s"});
    $(".boardsection[data-board]:nth-child(4)").css({animation: "next 1s"});
    $(".boardsection[data-board]:nth-child(5)").css({animation: "next 1s"});
    $(".boardsection[data-board]:nth-child(6)").css({animation: "next 1s"});
    $(".boardsection[data-board]:last-child").css({animation: "next 1s"});
